...
sendVarToJS('eqType', 'pushNotification');
$eqLogics = eqLogic::byType('pushNotification');
?>
            ...
            <fieldset>
				...
				<div class="form-horizontal">
					<div class="form-group">
						<label class="col-md-2 control-label">{{Nom de l'appareil}}</label>
						<div class="col-sm-3">
					...
					<div class="form-group">
						<label class="col-md-2 control-label">{{Adresse de l'appareil}}</label>
						<div class="col-sm-3">
							<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="adress" placeholder="{{Adresse de l'appareil}}"/>
						</div>
					</div>
				</div>
			</fieldset> 
...
<?php include_file('desktop', 'pushNotification', 'js', 'pushNotification'); ?>
